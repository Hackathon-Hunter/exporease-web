...
interface CountryMatchProps {
  countryName: string;
  matchPercentage: number;
  imageUrl: string;
}

const CountryMatch: React.FC<CountryMatchProps> = ({ countryName, matchPercentage, imageUrl }) => {
  return (
    <div className="flex gap-1">
      ...
      <div className="flex flex-col gap-2">
        ...
        <span className="text-[#079455] font-semibold">{matchPercentage}% tingkat kecocokan</span>
      </div>
    </div>
  );
};
