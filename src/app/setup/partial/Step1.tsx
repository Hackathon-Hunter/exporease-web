  ...
  return (
    <div className="flex flex-col gap-8 w-full max-w-lg md:w-[512px] justify-center items-center p-4 md:p-0">
      <div className="bg-white p-3 rounded-lg shadow w-fit">
        ...
        >
          <path
            d="M18.6667 8.16667C18.6667 7.0817 18.6667 6.53922 18.5474 6.09413C18.2238 4.88631 17.2804 3.94289 16.0726 3.61926C15.6275 3.5 15.085 3.5 14 3.5C12.9151 3.5 12.3726 3.5 11.9275 3.61926C10.7197 3.94289 9.77627 4.88631 9.45263 6.09413C9.33337 6.53922 9.33337 7.0817 9.33337 8.16667M6.06671 24.5H21.9334C23.2402 24.5 23.8936 24.5 24.3927 24.2457C24.8317 24.022 25.1887 23.665 25.4124 23.226C25.6667 22.7269 25.6667 22.0735 25.6667 20.7667V11.9C25.6667 10.5932 25.6667 9.93982 25.4124 9.44069C25.1887 9.00164 24.8317 8.64469 24.3927 8.42098C23.8936 8.16667 23.2402 8.16667 21.9334 8.16667H6.06671C4.75992 8.16667 4.10652 8.16667 3.6074 8.42098C3.16835 8.64469 2.8114 9.00164 2.58769 9.44069C2.33337 9.93982 2.33337 10.5932 2.33337 11.9V20.7667C2.33337 22.0735 2.33337 22.7269 2.58769 23.226C2.8114 23.665 3.16835 24.022 3.6074 24.2457C4.10652 24.5 4.75992 24.5 6.06671 24.5Z"
            stroke="#414651"
            strokeWidth="2"
            strokeLinecap="round"
      ...
      <div className="text-center md:text-left flex flex-col gap-2">
        <h3 className="text-2xl md:text-[30px] font-semibold text-center">
          Informasi Usaha
        </h3>
        <span className="text-sm md:text-base">
          Silakan isi informasi usaha anda di bawah ini
        </span>
      </div>
      ...
      <div className="flex flex-col gap-5 w-full">
        ...
        <div className="flex flex-col justify-start">
          <label className="text-start mb-2 flex items-center gap-1">
            Deskripsi usaha
            <span>
              <svg
                xmlns="http://www.w3.org/2000/svg"
        ...
        <div className="flex flex-col justify-start">
          ...
          <div className="flex">
            <span className="text-sm border-2 rounded-l-lg px-4 py-2 bg-white whitespace-no-wrap">
              https://
            </span>
            <input
              name="field_name"
